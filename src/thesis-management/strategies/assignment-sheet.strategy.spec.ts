...
import { AssignmentSheetStrategy } from './assignment-sheet.strategy';
...
describe('AssignmentSheetStrategy', () => {
  let strategy: AssignmentSheetStrategy;
  ...
  beforeEach(async () => {
    ...
    strategy = new AssignmentSheetStrategy(mockRepository, mockClassService, mockStorageService);
  });
  ...
  describe('create', () => {
    ...
    const createDto = { classId: '1', name: 'Test Assignment Sheet' };

    it('should create an assignment sheet successfully', async () => {
  ...
  describe('update', () => {
    const mockUser: UserPayload = { email: 'test@example.com', role: 'TEACHER' };
    const updateDto = { id: '1', name: 'Updated Assignment Sheet' };
    const existingEntity = {
      id: '1',
      name: 'Test Assignment Sheet',
      class: { teacher: { email: 'test@example.com' } },
    };

    it('should update an assignment sheet successfully', async () => {
    ...
    it('should throw BadRequestException if assignment sheet not found', async () => {
  ...
  describe('list', () => {
    ...
    const expectedResult = [
      { id: '1', name: 'Assignment 1', class: { id: '1' } },
      { id: '2', name: 'Assignment 2', class: { id: '1' } },
    ];

    it('should return a list of assignment sheets for a class', async () => {
  ...
  describe('delete', () => {
    ...
    it('should delete an assignment sheet with only inputPath', async () => {
      const entity = {
        id: '1',
    ...
    it('should update assignment sheet when it has outputPath', async () => {
      const entity = {
        id: '1',
        inputPath: 'path/to/input',
  ...
  describe('getOne', () => {
    ...
    it('should return an assignment sheet by id', async () => {
      mockRepository.findOne.mockResolvedValue(existingEntity);
    ...
    it('should return empty object if assignment sheet not found', async () => {
      mockRepository.findOne.mockResolvedValue(null);
  ...
  describe('deleteFile', () => {
    ...
    it('should delete output files from assignment sheets', async () => {
      const entities = [
